...
class alicevox extends tts_addon
{
    ...
    {
        $this->title   = "Alicevox";
        $this->description = '<b>Описание:</b>&nbsp;  Работает на медиацентрах KODI не ниже версии 18 (Leia) с установленным плагином  Alicevox. &nbsp;<a href="https://github.com/SergMicar/script.alicevox.master">Alicevox</a>.<br>Ссылка на &nbsp;<a href="https://mjdm.ru/forum/viewtopic.php?f=5&t=2893">тему форума</a>.<br>';
