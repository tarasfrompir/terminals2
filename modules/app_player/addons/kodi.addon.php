...
class kodi extends app_player_addon {
	...
	function __construct($terminal) {
		...
		$this->description .= '<b>Восстановление воспроизведения после TTS:</b>&nbsp; Да. (если ТТС такого же типа, что и плеер). Если же тип ТТС и тип плеера для терминала различны, то плейлист плеера при ТТС не потеряется в при любых обстоятельствах).<br>';
